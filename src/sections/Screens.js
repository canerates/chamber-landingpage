  ...
  return (
    <Scroll.Element name="Screens">
      <StyledGenericRoot ref={screensContainer} isMobile={isMobile}>
        ...
        >
          <PageHeader title="Screens" subText="Chamber AR has three main sections. Home, Design AR, Scan Texture. Home section consists of three main tabs: Home Tab, Furniture Tab, Texture Tab. Design AR section provides AR View. Scan Texture section let users scan real-world texture to apply it on AR design." />
        </StyledGenericContainer>
